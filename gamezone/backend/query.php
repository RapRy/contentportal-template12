<?php
    ...
    function getContentData($mysqli, $contentId){
        ...
        $query = "SELECT id, title, description, icon_file_name, content_file_name FROM cms.portal_content WHERE id = ?";
        ...
        $stmt->bind_result($id, $title, $description, $iconName, $fileName);
