                        ...
                        $.each(data, (i, val) => {
                            ...
                            switch(category){
                                case "Videos":
                                    ...
                                    break
                                case "Wallpaper":
                                    thumbnail = `<img src="${this.contenDir}/${originCatName.toLowerCase()}/${subCategory.toLowerCase()}/${contentName.toLowerCase()}/${fileName}" alt="${title}" />`
                                    break
                            }
        ...
        showPreview(data, catName, subCatName, originCatName){
            ...
            switch(catName){
                ...
                case "Wallpaper":
                    ...
                    thumbnail = `<img src="${this.contenDir}/${originCatName.toLowerCase()}/${subCatName.toLowerCase()}/${contentName.toLowerCase()}/${filename}" alt="${title}" />`

                    preview = `
                        <div class="videoPreview">
                            <img src="${this.contenDir}/${originCatName.toLowerCase()}/${subCatName.toLowerCase()}/${contentName.toLowerCase()}/${filename}" alt="${title}" />
                        </div>
                    `
                    break
            }
