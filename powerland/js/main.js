                                ...
                                case "Videos":
                                        thumbnail = `
                                            <video preload="metadata">
                                                <source src="${this.contenDir}/${originCatName.toLowerCase()}/${subCategory.toLowerCase()}/${contentName.toLowerCase()}/${fileName}" type="video/mp4" />
                                            </video>
                                        `
                                    break
                                case "Games":
                                case "Apps":
                                    thumbnail = `<img src="${this.contenDir}/${originCatName.toLowerCase()}/${subCategory.toLowerCase()}/${contentName.toLowerCase()}/${icon}" alt="${title}" />`
                                    break
                            }
        ...
        showPreview(data, catName, subCatName, originCatName){
            ...
            switch(catName){
                case "Tones":
                    ...
                    preview = `
                        <div class="tonePreview">
                            <span>Preview</span>
                            <audio controls>
                                <source src="${this.contenDir}/${originCatName.toLowerCase()}/${subCatName.toLowerCase()}/${contentName.toLowerCase()}/${filename.replaceAll(" ", "+")}" type="audio/mpeg" />
                            </audio>
                        </div>
                    `
                ...
                case "Videos":
                        thumbnail = `
                            <video preload="metadata">
                                <source src="${this.contenDir}/${originCatName.toLowerCase()}/${subCatName.toLowerCase()}/${contentName.toLowerCase()}/${filename.replaceAll(" ", "+")}" type="video/mp4" />
                            </video>
                        `
                        ...
                        <div class="videoPreview">
                            <span>Preview</span>
                            <video controls>
                                <source src="${this.contenDir}/${originCatName.toLowerCase()}/${subCatName.toLowerCase()}/${contentName.toLowerCase()}/${filename}" type="video/mp4" />
                            </video>
                        </div>
                    `
                    break
